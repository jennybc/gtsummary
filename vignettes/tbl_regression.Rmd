...
The default output from `tbl_regression()` is meant to be publication ready.  Let's start by creating a regression model table from the `gastric` data set included in the {gtsummary} package.  We will predict tumor response using age, stage, and grade using a logistic regression model.  

```{r, message=FALSE}
# build logistic regression model
m1 = glm(response ~ age + stage + grade, gastric, family = binomial(link = "logit"))
